...
<a name="model"></a>  
## Modeling - implementation and results 
...
RFC provides the best tradeoff-between execution time and accuracy. The default RFC provides an accuracy and F1-score of ~97%, which is quite impressive for a model with just 6 features.  This is shown in the figure below.

![class_results](/images/classifier_results.png)
